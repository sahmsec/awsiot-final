        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/courses/diploma" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  Professional Diploma Programs
                </Link>
              </li>
              <li>
                <Link href="#" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  Course Modules
                </Link>
              </li>
              <li>
                <Link href="/library" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  E-Library
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/about-us" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  About the Institute
                </Link>
              </li>
              <li>
                <Link href="/apply" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  Apply
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-[#bb1133] transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded bg-gray-800 hover:bg-[#bb1133] transition-colors"
                >
                  <Facebook className="w-4 h-4 text-white" />
                </a>

                <a
                  href="https://www.instagram.com/popular/arena-web-security/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded bg-gray-800 hover:bg-[#bb1133] transition-colors"
                >
